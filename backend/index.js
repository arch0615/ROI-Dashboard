...
const alertsRouter = require('./src/api/alerts');
const placementsPreviewRouter = require('./src/api/placements-preview');
const creativesPreviewRouter = require('./src/api/creatives-preview');
...
app.use('/api/placements', requireAuth, placementsPreviewRouter);
app.use('/api/creatives', requireAuth, creativesPreviewRouter);
